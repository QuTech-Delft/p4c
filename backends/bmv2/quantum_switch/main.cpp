...
#include "backends/bmv2/quantum_switch/midend.h"
#include "backends/bmv2/quantum_switch/quantumSwitch.h"
#include "backends/bmv2/quantum_switch/version.h"
...
int main(int argc, char *const argv[]) {
    ...
    AutoCompileContext autoBMV2Context(new BMV2::QuantumSwitchContext);
    auto& options = BMV2::QuantumSwitchContext::get().options();
    options.langVersion = CompilerOptions::FrontendVersion::P4_16;
    options.compilerVersion = BMV2_QUANTUMSWITCH_VERSION_STRING;
    ...
    BMV2::QuantumSwitchMidEnd midEnd(options);
    ...
    auto backend = new BMV2::QuantumSwitchBackend(options, &midEnd.refMap,
                                                  &midEnd.typeMap, &midEnd.enumMap);

    // Necessary because BMV2Context is expected at the top of stack in further processing
    AutoCompileContext autoContext(new BMV2::BMV2Context(BMV2::QuantumSwitchContext::get()));
    try {
