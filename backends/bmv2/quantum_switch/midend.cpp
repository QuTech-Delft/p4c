...
QuantumSwitchMidEnd::QuantumSwitchMidEnd(CompilerOptions& options, std::ostream* outStream)
: MidEnd(options) {
    auto evaluator = new P4::EvaluatorPass(&refMap, &typeMap);
    if (BMV2::QuantumSwitchContext::get().options().loadIRFromJson == false) {
        ...
        auto fillEnumMap = new P4::FillEnumMap(new EnumOn32Bits("v1quantum.p4"), &typeMap);
        addPasses({
