...
#ifndef _V1_QUANTUM_P4_
#define _V1_QUANTUM_P4_
...
struct qdevice_metadata_t {
    ...
    /// Parameters for entanglement swap.
    bit<16> swap_bsm_id;
    bit<9> swap_qubit_0;
    bit<9> swap_qubit_1;
...
struct xconnect_metadata_t {
    ...
    /// connected through a BSM. It is a specialised version of the multicast group. The key
    /// difference is that a BSM group MUST strictly have two entries.
    bit<16> bsm_grp;

    /// Additional metadata filled out at egress after a BSM multicast. It can be used to identify
    /// the other member of the BSM group.
    bit<16> bsm_info;
}
...
#define V1QUANTUM_METER_COLOR_GREEN  0
#define V1QUANTUM_METER_COLOR_YELLOW 1
#define V1QUANTUM_METER_COLOR_RED    2
 ...
 * must be CloneType.I2E.  If clone3 is called during cross connect
 * processing, the first parameter must be CloneType.Q2E.If clone3 is
 * called during egress processing, the first parameter must be
 * CloneType.E2E.
 *
